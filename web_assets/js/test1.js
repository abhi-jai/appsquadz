...
$('.review1').click(function(){
  ...
  var review1_count = $('.counting').attr('current_val');

  if(parseInt(review1_count)<=parseInt(d1))
  { 
   $('.content').hide();
   $('#content-'+review1_count+'').show();
   review1_count=review1_count-1;
   $('#optionsRadios'+review1_count).css("background-color", "yellow");
  }
...
var ele = document.getElementsByName("optionsRadios"+num);
 ...
 // ======================click on question number==========================================
    ...
    //    $('.counting').attr('current_val',id);//set curent value
    // }
// ======================Enddclick on question number==========================================

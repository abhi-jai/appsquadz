...
<div class="fixed-sidebar">
  <div class="fixed-sidebar-left sidebar--small" id="sidebar-left"> <a href="<?php echo site_url();?>welcome" class="logo">
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <ul class="left-menu">
        ...
        <li> <a href="<?php echo site_url();?>Coursedetail">
        ...
        <li> <a href="javascript:void(0)" onclick="alert('This Part is under Process!')">
  ...
  <div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1"> <a href="<?php echo site_url();?>welcome" class="logo">
    <div class="img-wrap"> <img src="<?php echo base_url();?>web_assets/img/logo.png" alt="eGyanshala"> </div>
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <div class="control-block">
        <div class="author-page author vcard inline-items">
          ...
          <a href="<?php echo site_url();?>welcome" class="author-name fn">

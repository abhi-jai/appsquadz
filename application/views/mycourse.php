  ...
  <div class="row">
    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
      <div class="clients-grid">
        ...
        <?php 
              // print_r($details[0]['course_list']);
              // exit();
        foreach($mycourse['mycourse'] as $dtl){
          ...
          <div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6 sorting-item ecommerce running">
            <div class="ui-block"> 
              ...
              <div class="friend-item">
                <div class="friend-header-thumb"> <img src="<?php echo $dtl['desc_header_image'];?>" alt="friend"> </div>
                <div class="friend-item-content">
                  <div class="friend-avatar">
                    <div class="author-thumb"> <img src="<?php echo $dtl['cover_image'];?>" alt="author"> </div>
                    <div class="author-content"> <a href="#" class="h5 author-name"><?php echo $dtl['title'];?></a>
                    ...
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide swiper-slide-active">
                        ...
                        <div class="friend-count">
                          ...
                          <div class="btn btn-blue btn-md-2"  onclick="location.href='<?php echo site_url();?>coursedetail'">View </div>
                        </div>
